...
@push('css')
<link rel="stylesheet" href="{{ asset('admin/vendor/selectric/public/selectric.css') }}">
@endpush
@section('content')
        ...
        <div class="row">
            <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                ...
                <div class="simple-footer">
                    Copyright &copy; Bibit Sriwedari 2022
                </div>
            </div>
        </div>
    </div>
...
@endsection
@push('js')
<script src="{{ asset('admin/vendor/jquery-pwstrength/jquery.pwstrength.min.js') }}"></script>
<script src="{{ asset('admin/vendor/selectric/public/jquery.selectric.min.js') }}"></script>
